const Data = {
    "projects": {
        4: {
            ...
            "presentationImage": "case-image.webp",
    ...
    "projects-details": {
        ...
        3: {
            "projectName": "Smoking Cessation App",
            "context": "One of the leading healthcare companies recently hired me as a design lead to rebrand their app to align with the the overall organisation branding and also design additional features that will enhance user engagement. The product I worked on aimed to help users quit smoking by offering features that combat cravings and reduce cigarette and nicotine intake. My task involves understanding the product, the company's brand, rebranding the app, and building new features.",
            "the challenge": "Many smoking cessation apps struggle to maintain user engagement over the long term. Users often relapse because the apps fail to provide personalized, continuous support and motivation. In creating new features, I need to address this issue by integrating personalized support systems, such as tailored progress tracking, cigarette tracking, interactive and motivational content, real-time assistance from a coach and activities to fight cravings.",
            "project goal": {
            ...
            "the process": {
                "desc": "After meeting with stakeholders and brainstorming, I assessed the existing smoking cessation app before going into the full redesign. I conducted a usability heuristic analysis and user testing to identify underlying problems.  This research provided useful insights and ideas, helping to create a clear roadmap for the project.\n\nThe UX phase began with understanding the users and their behaviors. I redesigned the information architecture to see which parts of the app needed more optimization.",
                "image": [
                    "process.webp",
                ]
            },
            ...
            ,
            "user testing": {
                "desc": "In other to evaluate the effectiveness of the designs  and new features created, we performed a usability testing. We recruited 10 participants and conducted a semi structured testing.",
                "image": [
                    "testing.webp",
                ]
            },
