    ...
    "projects-details": {
        3: {
            ...
            "Research Methods Employed": {
                "parts": {
                    "Behavioral Science Integration:": "Analyzed research data provided by the behavioral team, including user interviews and surveys conducted with individuals at different stages of the quitting journey.",
                    "Market and Competitor Analysis:": "Evaluated similar apps to identify features that worked well and gaps we could address.",
                    "User Persona Workshops:": "Conducted workshops with behavioral scientists and product stakeholders to refine and expand user personas..",
                    "COM-B Framework Application:": "Mapped user capabilities, opportunities, and motivations to understand the psychological, social, and environmental factors influencing their behaviors.",
                },
                "image": [
                    "process.webp",
                ]
            ...
            "Business Impact": {
                ...
                "parts": {
                    "User Adoption:": " Onboarding success improved by 60%, thanks to the streamlined flow and localized design.",
                    "App Downloads:": "Achieved 30,000 downloads in the first month across iOS and Android platforms.",
                    "Community Engagement:": "The new community hub saw a 70% engagement rate, fostering peer support and motivation.",
                    "In-app purchases:": "Sales of nicotine replacement therapies (NRTs) generated a 15% increase in revenue compared to the previous version.",
                },
                "image": [
                    "impact.png",
                ]
            ...
            "Overcoming Constraints": {
                "parts": {
                    "Regulatory Challenges": "Working closely with the legal team, I navigated EU regulations to ensure the app met health and privacy standards in all three countries. By building on existing frameworks and identifying gray areas, we avoided unnecessary delays and reduced compliance costs.",
                    "Development Constraints": "Given tight deadlines, I optimized existing design tools instead of creating components from scratch, enabling faster implementation and alignment with developers’ tools.",
                }
            },
